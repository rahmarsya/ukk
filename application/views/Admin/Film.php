                    ...
                    <div class="modal-body">
                        <form id="editUserForm" action="<?= base_url('tambah_film/')  ?>" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="tahun" name="id_tahun" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="negara" name="id_negara" required>
                        ...
                        <div class="modal-body">
                            <form id="editUserForm" action="<?= base_url('edit_film/') . $f->id_film; ?>" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="genre" name="id_genre" required>
                                        <?php foreach ($genre as $g) : ?>
                                            <option value="<?= $g->id_genre; ?>" <?= ($g->id_genre == $f->id_genre) ? 'selected' : ''; ?>>
                                                <?= $g->nama_genre; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="tahun" name="id_tahun" required>
                                        <?php foreach ($tahun as $t) : ?>
                                            <option value="<?= $t->id_tahun; ?>" <?= ($t->id_tahun == $f->id_tahun) ? 'selected' : ''; ?>>
                                                <?= $t->tahun_rilis; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="negara" name="id_negara" required>
                                        <?php foreach ($negara as $n) : ?>
                                            <option value="<?= $n->id_negara; ?>" <?= ($n->id_negara == $f->id_negara) ? 'selected' : ''; ?>>
                                                <?= $n->nama_negara; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
