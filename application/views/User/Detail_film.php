        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__links">
                    <a href="<?= base_url('dashboard_user') ?>"><i class="fa fa-home"></i> Home</a>
                ...
                <div class="col-lg-9">
                    <div class="anime__details__text">
                        ...
                        <div class="anime__details__btn">
                            <a href="<?= base_url('trailer/' . $detail_film->id_film) ?>" class="watch-btn"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
